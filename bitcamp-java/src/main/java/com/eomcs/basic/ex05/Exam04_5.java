...
public class Exam04_5 {
    public static void main(String[] args) {
        ...
        // 32bit 에서 뒤 8bit를 사용하여 8개의 true/false값을 저장할 수 있음
        // 8bit 에서 각 언어에 값을 저장할 비트를 다음과 같다고 가정.
        //  00000000
        //  ||||||||- css
        //  |||||||- html
        //  ||||||- php
        ...
        //준비된 32bit 메모리에서 특정 비트의 값을 1로 설정하고싶다면
        // 다음과 같이 특정 비트의 값이 1인수를 or | 연산하라
        lang2 |= 0x80; // c = true 
        ...
        // 실무에서는 비트를 이용하여 여러 데이터의 true/false상태를 저장하기도 함.

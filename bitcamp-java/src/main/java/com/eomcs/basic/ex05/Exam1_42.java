...
public class Exam1_42 {
  public static void main(String[] args) {
    ...
    System.out.println(r1); // 0x7fffffff + 0x7fffffff = 0xfffffffe = -2
    //int와 int의 연산결과가 int의 범위를 넘어갈 경우 예상못한 값이 나옴.
    //- int와 int의 연산 결과를 더 큰 메모리에 담을 시 해결되는가?
    
    long r2 = x + y;
    System.out.println(r2);//해결x
    // > int + int 연산 결과값이 int 크기를 넘어갈 시 형변환 후 계산하라
    r2 = (long)x + (long)y;

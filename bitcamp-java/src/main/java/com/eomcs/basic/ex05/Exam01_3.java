...
public class Exam01_3 {
    public static void main(String[] args) {
        ...
        b = 6;
        b = 5+6;
//java는 정수연산 최소단위가 4byte. 연산시 변수를 사용할 경우 byte/short의 연산단위는 기본 4byte. 
        // 리터럴 5, 6은 4바이트 정수 값이다.
        // 정수 literal은 기본이 4byte크기
        // byte 변수에 저장할 수 있다면 허락한다!
        // 리터럴끼리 산술 연산한 결과도 리터럴로 간주한다.
        // 결과값이 변수의 범위 내 값이면 허락함.
        // literal값은 컴파일 단계에서 그 값이 얼마인지 확인가능, 변수는 불가능하다.
        ...
        //   그 변수의 값이 4바이트 보다 작다면, 4byte로 만들어 연산을 수행함
